...
DEFAULT_INPUT_PDB = DEFAULT_PREPARED_PDB_DIR / "01_cleaned_pdb" / "protein_only_cleaned.pdb"
DEFAULT_OUTPUT_DIR = DEFAULT_STUDY_DIR / "02_openmm_md_setup" / "protein_only"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--prefix", default="protein_only")
...
def main() -> None:
    ...
    summary_path = args.output_dir / "summary_apo.txt"
