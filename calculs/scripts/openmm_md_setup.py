...
DEFAULT_VARIANTS_DIR = DEFAULT_STUDY_DIR / "03_variants"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Directori de sortida. Per defecte: STUDY_DIR/solvated_pdb.",
    )
    parser.add_argument("--prefix", default="protein_plus_ligand", help="Prefix dels fitxers AMBER.")
...
def main() -> None:
    ...
    if args.input_pdb is None:
        args.input_pdb = args.study_dir / "03_variants" / "protein_plus_ligand.pdb"
    if args.output_dir is None:
        args.output_dir = args.study_dir / "solvated_pdb"
