...
DEFAULT_PRMTOP = DEFAULT_STUDY_DIR / "02_openmm_md_setup" / "protein_holo" / "protein_holo.prmtop"
DEFAULT_INPCRD = DEFAULT_STUDY_DIR / "02_openmm_md_setup" / "protein_holo" / "protein_holo.inpcrd"
DEFAULT_RUN_NAME = "run_001"
DEFAULT_OUTPUT_BASE_DIR = DEFAULT_ANALYSIS_DAT_DIR / "holo"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "Nom del tram de simulacio si no es passa --output-dir. "
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Checkpoint d un tram anterior per iniciar aquest run. "
            "Si ja existeix el checkpoint dins --output-dir, es repren aquell."
        ),
    )
    parser.add_argument(
        "--state-in",
...
def main() -> None:
    ...
    dcd_path = args.output_dir / "trajectory-holo.dcd"
    log_path = args.output_dir / "log-holo.txt"
    checkpoint_path = args.output_dir / "checkpoint-holo.chk"
    state_path = args.output_dir / "state-holo.xml"
