...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Topologia/PDB final. Per defecte: STUDY_DIR/calculs/study_runs/amber_simulation_apo/final.pdb.",
    )
    parser.add_argument(
        "--trajectory",
        type=Path,
        default=None,
        help="Trajectoria DCD. Per defecte: STUDY_DIR/calculs/study_runs/amber_simulation_apo/trajectory-apo.dcd.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("calculs/analisi/data"),
        help="Directori de sortida. Per defecte: STUDY_DIR/calculs/analisi/data.",
    )
...
def main() -> None:
    ...
    if args.topology is None:
        args.topology = args.study_dir / "amber_simulation_apo" / "final.pdb"
    if args.trajectory is None:
        args.trajectory = args.study_dir / "amber_simulation_apo" / "trajectory-apo.dcd"
    if args.output_dir is None:
        args.output_dir = args.study_dir / "calculs" / "analisi" / "data"
